...
class RemoteDataSourceImpl extends RemoteDataSource {
  ...
  Future<List<NewsEntity>> getCategoryNews(String category) async {
    ...
    return _fetchAndCacheNews(endPoint, kCategoryNewsBox);
  }
  ...
  Future<List<NewsEntity>> getTopRatedNews() async {
    const endPoint =
        'v2/top-headlines?country=us&apiKey=${ApiServices.apiKey}';
    return _fetchAndCacheNews(endPoint, kTopRatedNewsBox);
  }
  ...
  Future<List<NewsEntity>> getTrendingNews() async {
    const endPoint =
        'v2/top-headlines?country=us&apiKey=${ApiServices.apiKey}';
    return _fetchAndCacheNews(endPoint, kTrendingNewsBox);
  }
}
